from binance_d.impl import RestApiRequest
...
from binance_d.impl.utils.apisignature import create_signature_with_query
from binance_d.impl.utils.inputchecker import *
from binance_d.impl.utils.timeservice import *
...
class RestApiRequestImpl(object):
    ...
    def get_exchange_information(self):
        builder = UrlParamsBuilder()
        request = self.__create_request_by_get("/dapi/v1/exchangeInfo", builder)
    ...
    def get_recent_trades_list(self, symbol, limit):
        ...
        request = self.__create_request_by_get("/dapi/v1/trades", builder)
    ...
    def get_old_trade_lookup(self, symbol, limit, fromId):
        ...
        request = self.__create_request_by_get_with_apikey("/dapi/v1/historicalTrades", builder)
    ...
    def get_candlestick_data(self, symbol, interval, startTime, endTime, limit):
        ...
        request = self.__create_request_by_get("/dapi/v1/klines", builder)
    ...
    def get_symbol_price_ticker(self, symbol):
        ...
        request = self.__create_request_by_get("/dapi/v1/ticker/price", builder)
    ...
    def get_symbol_orderbook_ticker(self, symbol):
        ...
        request = self.__create_request_by_get("/dapi/v1/ticker/bookTicker", builder)
    ...
    def get_open_interest(self, symbol):
        ...
        request = self.__create_request_by_get("/dapi/v1/openInterest", builder)
    ...
    def get_liquidation_orders(self, symbol, startTime, endTime, limit):
        ...
        request = self.__create_request_by_get("/dapi/v1/allForceOrders", builder)
    ...
    def get_order(self, symbol, orderId, origClientOrderId):
        ...
        request = self.__create_request_by_get_with_signature("/dapi/v1/order", builder)
    ...
    def cancel_order(self, symbol, orderId, origClientOrderId):
        ...
        request = self.__create_request_by_delete_with_signature("/dapi/v1/order", builder)
    ...
    def cancel_list_orders(self, symbol, orderIdList, origClientOrderIdList):
        ...
        request = self.__create_request_by_delete_with_signature("/dapi/v1/batchOrders", builder)
    ...
    def get_open_orders(self, symbol):
        ...
        request = self.__create_request_by_get_with_signature("/dapi/v1/openOrders", builder)
    ...
    def get_all_orders(self, symbol, orderId, startTime, endTime, limit):
        ...
        request = self.__create_request_by_get_with_signature("/dapi/v1/allOrders", builder)
    ...
    def get_account_information(self):
        ...
        request = self.__create_request_by_get_with_signature("/dapi/v1/account", builder)
    ...
    def change_initial_leverage(self, symbol, leverage):
        ...
        request = self.__create_request_by_post_with_signature("/dapi/v1/leverage", builder)
    ...
    def change_position_margin(self, symbol, amount, type):
        ...
        request = self.__create_request_by_post_with_signature("/dapi/v1/positionMargin", builder)
    ...
    def get_position_margin_change_history(self, symbol, type, startTime, endTime, limit):
        ...
        request = self.__create_request_by_get_with_signature("/dapi/v1/positionMargin/history", builder)
    ...
    def get_position(self):
        ...
        request = self.__create_request_by_get_with_signature("/dapi/v1/positionRisk", builder)
    ...
    def get_account_trades(self, symbol, startTime, endTime, fromId, limit):
        ...
        request = self.__create_request_by_get_with_signature("/dapi/v1/userTrades", builder)
    ...
    def start_user_data_stream(self):
        ...
        request = self.__create_request_by_post_with_signature("/dapi/v1/listenKey", builder)
    ...
    def keep_user_data_stream(self):
        ...
        request = self.__create_request_by_put_with_signature("/dapi/v1/listenKey", builder)
    ...
    def close_user_data_stream(self):
        ...
        request = self.__create_request_by_delete_with_signature("/dapi/v1/listenKey", builder)
    ...
    def get_open_interest_stats(self, pair, contractType, period, startTime, endTime, limit):
        builder = UrlParamsBuilder()
        builder.put_url("pair", pair)
        builder.put_url("contractType", contractType)
    ...
    def get_top_long_short_accounts(self, pair, period, startTime, endTime, limit):
        builder = UrlParamsBuilder()
        builder.put_url("pair", pair)
        builder.put_url("period", period)
        builder.put_url("startTime", startTime)
    ...
    def get_top_long_short_positions(self, pair, period, startTime, endTime, limit):
        builder = UrlParamsBuilder()
        builder.put_url("pair", pair)
        builder.put_url("period", period)
        builder.put_url("startTime", startTime)
    ...
    def get_global_long_short_accounts(self, pair, period, startTime, endTime, limit):
        builder = UrlParamsBuilder()
        builder.put_url("pair", pair)
        builder.put_url("period", period)
        builder.put_url("startTime", startTime)
    ...
    def get_taker_buy_sell_vol(self, pair, contractType, period, startTime, endTime, limit):
        builder = UrlParamsBuilder()
        builder.put_url("pair", pair)
        builder.put_url("contractType", contractType)
        builder.put_url("period", period)
        ...
        request = self.__create_request_by_get("/futures/data/takerBuySellVol", builder)

        def parse(json_wrapper):
            result = list()
            data_list = json_wrapper.convert_2_array()
            for item in data_list.get_items():
                element = TakerBuySellVol.json_parse(item)
                result.append(element)
            return result
    ...
    def auto_cancel_all_orders(self, symbol, countdownTime):
        ...
        request = self.__create_request_by_post_with_signature("/dapi/v1/countdownCancelAll", builder)
    ...
    def get_leverage_bracket(self, pair):
        ...
        request = self.__create_request_by_get_with_signature("/dapi/v1/leverageBracket", builder)
    ...
    def get_adl_quantile(self, symbol):
        ...
        request = self.__create_request_by_get_with_signature("/dapi/v1/adlQuantile", builder)
